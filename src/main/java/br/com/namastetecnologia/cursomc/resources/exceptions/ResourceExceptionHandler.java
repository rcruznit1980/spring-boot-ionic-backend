package br.com.namastetecnologia.cursomc.resources.exceptions;
...
import br.com.namastetecnologia.cursomc.services.exceptions.AuthorizationException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonS3(AmazonS3Exception e, HttpServletRequest request){
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro S3t", e.getMessage(), request.getRequestURI()) ;
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
